...
<div class="well well-small">
	...
	<div class="row-fluid">
			...
			<div id="myCarousel" class="carousel slide cntr">
                <div class="carousel-inner">
                  <div class="item active">
                   <a href="#"> <img src='<c:url value="/assets/user/img/${product.img }"></c:url>' alt="" style="width:100%"></a>
                  </div>
                 </div>
			...
			<c:set var="countList" value="${productByIdCatelogy.size() }" ></c:set>
			<c:if test="${productByIdCatelogy.size() > 5}">
				<c:set var="countList" value="5" ></c:set>
			</c:if>
			
			<c:forEach var="item" items="${ productByIdCatelogy}" begin="1" end="${countList }" varStatus="loop">>
				<div class="row-fluid">	  
			<div class="span2">
			...
			<h3> <fmt:formatNumber type="number" groupingUsed="true"
														value="${product.price}" />₫</h3>
